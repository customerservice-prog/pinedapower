...
import { IconHome, IconLibrary, IconSettings, IconStar, IconUsers } from "./icons";
  ...
  return (
    ...
    >
      ...
      <nav style={{ display: "flex", flexDirection: "column", gap: 2 }}>
        ...
        <SidebarLink
          href="/vault?view=favorites"
          label="Favorites"
          isActive={active === "favorites"}
        >
          <IconStar size={17} />
        </SidebarLink>
        <SidebarLink href="/family-tree" label="Family Tree" isActive={active === "family"}>
          <IconUsers size={17} />
        </SidebarLink>
      </nav>
